...
Open your terminal, navigate to this folder (`Week07/04.SQL-Injection-Lab`), and run:
...
2. On the left sidebar, under **Servers**, expand the pre-loaded server named **ITEC617 - Week 07 Topic 04 DB**.
...
3. Test your SQL injection queries against the `Users` table as outlined in the `README.md`.
