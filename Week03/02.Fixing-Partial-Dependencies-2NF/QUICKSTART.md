...
This guide will help you get the environment up and running for the "Fixing Partial Dependencies (2NF)" exercise.
...
2. On the left side, under **Servers**, expand the pre-loaded server: **ITEC617 - Week 03 DB - 2NF**.
