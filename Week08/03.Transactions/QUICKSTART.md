...
2. On the left sidebar, under **Servers**, expand the pre-loaded server named **ITEC617 - Week 08 DB (Transactions)**.
3. When prompted, enter the database password: `password` (you only need to do this once per session).
4. Expand **Databases** -> **itec617** -> **Schemas** -> **public** to view the tables.
